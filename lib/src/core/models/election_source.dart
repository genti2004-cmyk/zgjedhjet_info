...
class ElectionSource {
  ...
  static const ElectionSource parliamentary2025 = ElectionSource(
    ...
    description: 'Rezultatet për subjektet politike, kandidatët dhe statistikat e zgjedhjeve parlamentare.',
  ...
  static const ElectionSource parliamentary2021 = ElectionSource(
    ...
    description: 'Rezultatet e përgjithshme sipas subjekteve politike dhe ndarja e mandateve nga dokumentet zyrtare të KQZ.',
    officialUrl: 'https://kqz-ks.org/zgjedhjet-e-pergjithshme/zgjedhjet-per-kuvend-te-kosoves-2021/',
    dateLabel: '14.02.2021',
  );

  static const ElectionSource parliamentary2019 = ElectionSource(
    type: ElectionSourceType.parliamentary2019,
    title: 'Zgjedhjet për Kuvendin e Kosovës 2019',
    shortTitle: 'Parlamentare 2019',
    description: 'Rezultatet e përgjithshme sipas subjekteve politike dhe ndarja e mandateve nga dokumentet zyrtare të KQZ.',
    officialUrl: 'https://kqz-ks.org/zgjedhjet-e-pergjithshme/zgjedhjet-per-kuvend-te-kosoves-2019/',
  ...
  static const ElectionSource local2025 = ElectionSource(
    ...
    description: 'Rezultatet për kryetarë komunash, kuvende komunale dhe pjesëmarrje sipas komunave.',
  ...
  static const ElectionSource local2025Round2 = ElectionSource(
    ...
    description: 'Rezultatet e raundit të dytë për kryetarë komunash në komunat përkatëse.',
