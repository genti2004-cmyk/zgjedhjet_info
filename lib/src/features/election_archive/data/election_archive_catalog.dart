...
class ElectionArchiveCatalog {
  ...
  static const List<ElectionArchiveItem> items = [
    ...
    ElectionArchiveItem(
      ...
      shortTitle: 'Kryetarët 2025',
      type: 'Lokale - Kryetarë',
      dateLabel: '12.10.2025 / 09.11.2025',
      statusLabel: 'Raundi i parë dhe balotazhi janë importuar nga dokumentet zyrtare të KQZ.',
    ...
    ElectionArchiveItem(
      ...
      statusLabel: 'Rezultatet për kuvende komunale dhe kandidatët sipas komunave janë vendosur nga dokumentet zyrtare të KQZ.',
      sourceUrl: 'https://kqz-ks.org/rezultatet/zgjedhjet-per-kuvende-komunale/',
      hasOfficialResultsInApp: true,
      hasCandidateDataInApp: true,
      hasMunicipalityDataInApp: true,
    ),
