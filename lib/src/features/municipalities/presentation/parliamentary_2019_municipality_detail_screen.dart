...
import '../../parliamentary_2019/data/parliamentary_2019_municipality_party_data.dart';

class Parliamentary2019MunicipalityDetailScreen extends StatefulWidget {
  final String municipalityName;

  const Parliamentary2019MunicipalityDetailScreen({
    super.key,
    required this.municipalityName,
  });

  @override
  State<Parliamentary2019MunicipalityDetailScreen> createState() =>
      _Parliamentary2019MunicipalityDetailScreenState();
}

class _Parliamentary2019MunicipalityDetailScreenState
    extends State<Parliamentary2019MunicipalityDetailScreen> {
  ...
  List<MunicipalityPartyResult> get _allResults {
    return Parliamentary2019MunicipalityPartyData.forMunicipality(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Parlamentare 2019 · Rezultatet sipas subjekteve',
                  style: TextStyle(
