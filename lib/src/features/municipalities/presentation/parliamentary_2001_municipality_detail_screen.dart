...
import '../../parliamentary_2001/data/parliamentary_2001_municipality_party_data.dart';

class Parliamentary2001MunicipalityDetailScreen extends StatefulWidget {
  final String municipalityName;

  const Parliamentary2001MunicipalityDetailScreen({
    super.key,
    required this.municipalityName,
  });

  @override
  State<Parliamentary2001MunicipalityDetailScreen> createState() =>
      _Parliamentary2001MunicipalityDetailScreenState();
}

class _Parliamentary2001MunicipalityDetailScreenState
    extends State<Parliamentary2001MunicipalityDetailScreen> {
  ...
  List<MunicipalityPartyResult> get _allResults {
    return Parliamentary2001MunicipalityPartyData.forMunicipality(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Parlamentare 2001 · Rezultatet sipas subjekteve',
                  style: TextStyle(
