...
import '../../parliamentary_2010/data/parliamentary_2010_municipality_party_data.dart';

class Parliamentary2010MunicipalityDetailScreen extends StatefulWidget {
  final String municipalityName;

  const Parliamentary2010MunicipalityDetailScreen({
    super.key,
    required this.municipalityName,
  });

  @override
  State<Parliamentary2010MunicipalityDetailScreen> createState() =>
      _Parliamentary2010MunicipalityDetailScreenState();
}

class _Parliamentary2010MunicipalityDetailScreenState
    extends State<Parliamentary2010MunicipalityDetailScreen> {
  ...
  List<MunicipalityPartyResult> get _allResults {
    return Parliamentary2010MunicipalityPartyData.forMunicipality(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Parlamentare 2010 · Rezultatet sipas subjekteve',
                  style: TextStyle(
