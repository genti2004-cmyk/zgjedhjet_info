...
import '../../parliamentary_2014/data/parliamentary_2014_municipality_party_data.dart';

class Parliamentary2014MunicipalityDetailScreen extends StatefulWidget {
  final String municipalityName;

  const Parliamentary2014MunicipalityDetailScreen({
    super.key,
    required this.municipalityName,
  });

  @override
  State<Parliamentary2014MunicipalityDetailScreen> createState() =>
      _Parliamentary2014MunicipalityDetailScreenState();
}

class _Parliamentary2014MunicipalityDetailScreenState
    extends State<Parliamentary2014MunicipalityDetailScreen> {
  ...
  List<MunicipalityPartyResult> get _allResults {
    return Parliamentary2014MunicipalityPartyData.forMunicipality(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Parlamentare 2014 · Rezultatet sipas subjekteve',
                  style: TextStyle(
