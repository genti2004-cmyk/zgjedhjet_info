...
import '../../parliamentary_2004/data/parliamentary_2004_municipality_party_data.dart';

class Parliamentary2004MunicipalityDetailScreen extends StatefulWidget {
  final String municipalityName;

  const Parliamentary2004MunicipalityDetailScreen({
    super.key,
    required this.municipalityName,
  });

  @override
  State<Parliamentary2004MunicipalityDetailScreen> createState() =>
      _Parliamentary2004MunicipalityDetailScreenState();
}

class _Parliamentary2004MunicipalityDetailScreenState
    extends State<Parliamentary2004MunicipalityDetailScreen> {
  ...
  List<MunicipalityPartyResult> get _allResults {
    return Parliamentary2004MunicipalityPartyData.forMunicipality(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Parlamentare 2004 · Rezultatet sipas subjekteve',
                  style: TextStyle(
