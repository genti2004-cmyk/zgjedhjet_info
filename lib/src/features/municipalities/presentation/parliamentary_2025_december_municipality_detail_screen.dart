...
import '../../parliamentary_2025_december/data/parliamentary_2025_december_municipality_party_data.dart';

class Parliamentary2025DecemberMunicipalityDetailScreen extends StatefulWidget {
  final String municipalityName;

  const Parliamentary2025DecemberMunicipalityDetailScreen({
    super.key,
    required this.municipalityName,
  });

  @override
  State<Parliamentary2025DecemberMunicipalityDetailScreen> createState() =>
      _Parliamentary2025DecemberMunicipalityDetailScreenState();
}

class _Parliamentary2025DecemberMunicipalityDetailScreenState
    extends State<Parliamentary2025DecemberMunicipalityDetailScreen> {
  ...
  List<MunicipalityPartyResult> get _allResults {
    return Parliamentary2025DecemberMunicipalityPartyData.forMunicipality(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  '28 Dhjetor 2025 · Rezultatet sipas subjekteve',
                  style: TextStyle(
