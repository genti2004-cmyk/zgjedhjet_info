...
import '../../parliamentary_2007/data/parliamentary_2007_municipality_party_data.dart';

class Parliamentary2007MunicipalityDetailScreen extends StatefulWidget {
  final String municipalityName;

  const Parliamentary2007MunicipalityDetailScreen({
    super.key,
    required this.municipalityName,
  });

  @override
  State<Parliamentary2007MunicipalityDetailScreen> createState() =>
      _Parliamentary2007MunicipalityDetailScreenState();
}

class _Parliamentary2007MunicipalityDetailScreenState
    extends State<Parliamentary2007MunicipalityDetailScreen> {
  ...
  List<MunicipalityPartyResult> get _allResults {
    return Parliamentary2007MunicipalityPartyData.forMunicipality(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Parlamentare 2007 · Rezultatet sipas subjekteve',
                  style: TextStyle(
