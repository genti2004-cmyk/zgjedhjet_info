...
import '../../parliamentary_2017/data/parliamentary_2017_municipality_party_data.dart';

class Parliamentary2017MunicipalityDetailScreen extends StatefulWidget {
  final String municipalityName;

  const Parliamentary2017MunicipalityDetailScreen({
    super.key,
    required this.municipalityName,
  });

  @override
  State<Parliamentary2017MunicipalityDetailScreen> createState() =>
      _Parliamentary2017MunicipalityDetailScreenState();
}

class _Parliamentary2017MunicipalityDetailScreenState
    extends State<Parliamentary2017MunicipalityDetailScreen> {
  ...
  List<MunicipalityPartyResult> get _allResults {
    return Parliamentary2017MunicipalityPartyData.forMunicipality(
  ...
  List<MunicipalityPartyResult> get _visibleResults {
    ...
    return _allResults.where((item) {
      return item.subjectName.toLowerCase().contains(query) ||
          ...
          item.subjectCode.contains(query);
    }).toList();
  }
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Parlamentare 2017 · Rezultatet sipas subjekteve',
                  style: TextStyle(
